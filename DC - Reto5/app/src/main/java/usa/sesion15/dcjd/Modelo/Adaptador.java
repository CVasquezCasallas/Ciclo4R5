...
import usa.sesion15.dcjd.Modelo.BaseDatos.MotorBaseDatosSQLite;
...
public class Adaptador extends BaseAdapter {
    ...
    public View getView(int posicion, View v, ViewGroup viewGroup) {
        ...
        String imagenOracle = datosItem.getImagen();
        Picasso.get().load(imagenOracle).fit().error(R.mipmap.logodcjd_foreground).into(imagen);
